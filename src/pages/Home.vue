            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 class="title-2">
                        ...
                        <a href="https://brasil.io/dataset/covid19/" target="_blank">https://brasil.io/dataset/covid19/</a> 
...
export default {
    ...
    methods:{
        ...
        getData(){
            axios.get("https://brasil.io/api/dataset/covid19/caso/data?is_last=True&state=PB")
            .then((response) => {
                let patos = {};
